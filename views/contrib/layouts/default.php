...
<body class=" h-100">
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        <a href="<?= $router->url('accueil_contrib') ?>" class="navbar-brand d-flex flex-column"><img src="/images/Logo_la_rochelle.svg" alt="Logo de la ville de La Rochelle en Charente-Maritime">DANS MA RUE</a>
