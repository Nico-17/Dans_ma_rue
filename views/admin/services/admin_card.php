<div class="card mb-4">
    <div class="card-body">
        ...
        <form action="<?= $router->url('admin_service_delete', ['services' => $service->getServices()]) ?>" method="POST" onsubmit="return confirm('Voulez vous vraiment effectuer cette action ?')" style="display:inline">
